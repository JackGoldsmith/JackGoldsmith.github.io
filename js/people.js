...

{
  (function () {
    ...
    var run = function run() {
      ...
      ctx.fillStyle = "#222";
      ctx.fillRect(0, 0, work.width, work.height * 0.15);
      ctx.fillRect(0, work.height * 0.85, work.width, work.height * 0.15);
    ...
    var Robot = function () {
      ...
      Robot.prototype.update = function update() {
        ...
        for (var _iterator5 = this.links, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
          ...
          // ---- ground ----
          if (p1.y > work.height * ground - link.size * 0.5) {
            p1.y = work.height * ground - link.size * 0.5;
            p1.x -= p1.vx;
            p1.vx = 0;
            p1.vy = 0;
          }
          ...
          // ---- borders ----
          if (p1.id === 1 || p1.id === 2) {
            if (p1.x > work.width - link.size) p1.x = work.width - link.size;else if (p1.x < link.size) p1.x = link.size;
          }
        }
      };
    ...
    var Link = function Link(parent, p0, p1, dist, size, light, force) {
      ...
      function stroke(color, axis) {
        var image = document.createElement("work");
    ...
    var work = function () {
      function work() {
        ...
        this.elem = document.createElement("work");
      ...
      work.prototype.resize = function resize() {
    ...
    var Pointer = function () {
      function Pointer(work) {
        ...
        work.elem.addEventListener("touchmove", function (e) {
          return _this2.move(e);
        }, false);
    ...
    for (var i = 0; i < 6; i++) {
      dancers.push(new Robot(i * 360 / 7, 80, 4, (i + 2) * work.width / 9, work.height * ground - 295, struct));
    }
